...
export function DislikedVideosTab() {
  ...
  const dislikedVideos = Object.values(reactions).filter(
  ...
  if (dislikedVideos.length === 0) {
    return (
      <View style={styles.emptyContainer}>
        <FontAwesome name="thumbs-down" size={48} color={Colors[colorScheme].text} style={styles.emptyIcon} />
  ...
  return (
    <View style={styles.gridContainer}>
      {dislikedVideos.map((reaction: EnrichedUserVideoReaction) => (
        <Pressable 
